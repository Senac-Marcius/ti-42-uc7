...
docker run -d --network host --dns 8.8.8.8 -p 80:80 -p 21:21 -p 22:22 -p 10050:10050 --restart unless-stopped --name nginx-ssh-ftp-demo-container nginx-ssh-ftp-demo
